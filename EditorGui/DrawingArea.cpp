...
void DrawingArea::drawPath(QPainter& painter, std::vector<QPoint> points) {
  ...
  // TODO: SetPenWidth in relation to current weight? Ignore weight of control
  // points?
...
std::vector<QPoint> DrawingArea::toQPoints(
    std::vector<esl::ControlPoint> list) {
...
void DrawingArea::setControlPointListReference(
    std::vector<esl::ControlPoint>* cpl) {
  controlPointList = cpl;
}

void DrawingArea::setControlPointWeightReference(double* cpw) {
