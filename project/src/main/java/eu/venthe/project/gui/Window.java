...
public class Window {
  ...
  private final ImageIcon IMAGEICON_DELETE = new ImageIcon(Window.class.getResource("/delete.png"));
  private final ImageIcon IMAGEICON_REFRESH = new ImageIcon(
      Window.class.getResource("/refresh.png"));
  private final ImageIcon IMAGEICON_PREVIEW_DEFAULT = new ImageIcon(
        ...
        gl_directoriesJTabbedPane.createParallelGroup(Alignment.TRAILING)
            .addGroup(gl_directoriesJTabbedPane.createSequentialGroup()
                ...
                .addGroup(gl_directoriesJTabbedPane.createParallelGroup(Alignment.LEADING)
                    .addComponent(thumbnailJScrollPane, GroupLayout.DEFAULT_SIZE, 446,
                        Short.MAX_VALUE)
                    ...
                    .addGroup(gl_directoriesJTabbedPane.createSequentialGroup()
                        ...
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(refreshDirectoryListingJButton, GroupLayout.PREFERRED_SIZE,
        ...
        gl_directoriesJTabbedPane.createParallelGroup(Alignment.LEADING)
            .addGroup(gl_directoriesJTabbedPane.createSequentialGroup()
                ...
                .addGroup(gl_directoriesJTabbedPane.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directoryJLabel)
                    .addComponent(directoryListingJComboBox, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(refreshDirectoryListingJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(directoryListingJScrollPane, GroupLayout.DEFAULT_SIZE, 186,
                    Short.MAX_VALUE)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(thumbnailJScrollPane, GroupLayout.PREFERRED_SIZE, 234,
                    GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
    );
        ...
        gl_operationsJPanel.createParallelGroup(Alignment.LEADING)
            .addGroup(gl_operationsJPanel.createSequentialGroup()
                ...
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.LEADING)
                    .addComponent(directorySelectionJLabel, GroupLayout.DEFAULT_SIZE, 263,
                        Short.MAX_VALUE)
                    .addGroup(gl_operationsJPanel.createSequentialGroup()
                        .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.LEADING, false)
                            .addComponent(directorySelection5BrowseJButton,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(directorySelection4BrowseJButton,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(directorySelection3BrowseJButton,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(directorySelection2BrowseJButton,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(directorySelection1BrowseJButton,
                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE))
                        .addGap(10)
                        .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.TRAILING)
                            .addComponent(directorySelection5JTextField, GroupLayout.DEFAULT_SIZE,
                                148, Short.MAX_VALUE)
                            .addComponent(directorySelection4JTextField, GroupLayout.DEFAULT_SIZE,
                                148, Short.MAX_VALUE)
                            .addComponent(directorySelection3JTextField, GroupLayout.DEFAULT_SIZE,
                                148, Short.MAX_VALUE)
                            .addComponent(directorySelection2JTextField, GroupLayout.DEFAULT_SIZE,
                                148, Short.MAX_VALUE)
                            .addGroup(gl_operationsJPanel.createSequentialGroup()
                                .addPreferredGap(ComponentPlacement.UNRELATED)
                                .addComponent(directorySelection1JTextField,
                                    GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)))
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.LEADING)
                            .addComponent(directorySelection5ClearJButton,
                                GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
                            .addComponent(directorySelection4ClearJButton,
                                GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
                            .addComponent(directorySelection3ClearJButton,
                                GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
                            .addComponent(directorySelection2ClearJButton,
                                GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
                            .addComponent(directorySelection1ClearJButton,
                                GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)))
                    .addComponent(operationsJLabel, GroupLayout.PREFERRED_SIZE, 228,
                        GroupLayout.PREFERRED_SIZE)
                    .addGroup(gl_operationsJPanel.createSequentialGroup()
                        .addComponent(operationsMergeJButton, GroupLayout.PREFERRED_SIZE, 69,
                            GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(operationsMergeTypeJComboBox, GroupLayout.PREFERRED_SIZE,
                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(operationsMergeMethodJComboBox, 0, 136, Short.MAX_VALUE))
                    .addGroup(gl_operationsJPanel.createSequentialGroup()
                        .addComponent(operationsSaveJButton, GroupLayout.PREFERRED_SIZE, 69,
                            GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(operationsSaveExtensionJComboBox, 0, 188, Short.MAX_VALUE))
                    .addComponent(operationsDisposeJButton)
                    .addComponent(operationsRotateJButton, GroupLayout.PREFERRED_SIZE, 69,
                        GroupLayout.PREFERRED_SIZE)
        ...
        gl_operationsJPanel.createParallelGroup(Alignment.LEADING)
            .addGroup(gl_operationsJPanel.createSequentialGroup()
                ...
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directorySelection1JTextField, GroupLayout.DEFAULT_SIZE, 20,
                        Short.MAX_VALUE)
                    .addComponent(directorySelection1ClearJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection1BrowseJButton, GroupLayout.DEFAULT_SIZE, 26,
                        Short.MAX_VALUE))
                .addGap(9)
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directorySelection2JTextField, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection2ClearJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection2BrowseJButton, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(9)
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directorySelection3JTextField, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection3ClearJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection3BrowseJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE))
                .addGap(9)
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directorySelection4JTextField, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection4ClearJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection4BrowseJButton))
                .addGap(9)
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(directorySelection5JTextField, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection5ClearJButton, GroupLayout.PREFERRED_SIZE, 20,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(directorySelection5BrowseJButton, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(ComponentPlacement.RELATED)
                ...
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    ...
                    .addComponent(operationsMergeTypeJComboBox, GroupLayout.PREFERRED_SIZE, 22,
                        GroupLayout.PREFERRED_SIZE)
                    .addComponent(operationsMergeMethodJComboBox, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(gl_operationsJPanel.createParallelGroup(Alignment.BASELINE)
                    .addComponent(operationsSaveJButton)
                    .addComponent(operationsSaveExtensionJComboBox, GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(operationsDisposeJButton)
                .addPreferredGap(ComponentPlacement.RELATED)
    ...
    groupLayout.setHorizontalGroup(
        groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(groupLayout.createSequentialGroup()
                ...
                .addGap(18)
                .addComponent(operationsJPanel, GroupLayout.PREFERRED_SIZE, 283,
                    GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
    );
        ...
        groupLayout.createParallelGroup(Alignment.TRAILING)
            .addGroup(groupLayout.createSequentialGroup()
                ...
                .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
                    .addComponent(operationsJPanel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
                        526, Short.MAX_VALUE)
                    .addComponent(tabbedJPanel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 526,
                        Short.MAX_VALUE))
                .addContainerGap())
    );
  ...
  private void updateCachedImages(int id, String path) {
    ...
    System.out.println(
        "Images cached from directory " + id + ": " + cachedImagesFromDirectories.get(id).size());
  }
