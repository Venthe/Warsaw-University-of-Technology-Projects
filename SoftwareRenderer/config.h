...
void SetSettings(int x = 640, int y = 480, Vector3<double> Origin = Vector3<double>(-0.7, 0.7, -5.0), Vector3<double> Rotation = Vector3<double>(0.0, 0.0, 0.0), double FocalLength = 25.);
